...
from promoai.pn_to_powl.converter_utils.powl_to_code import (
    translate_powl_to_code,
)
...
class LLMProcessModelGenerator:
    ...
    @classmethod
    def from_powl(cls, powl_model: POWL) -> Self:
    ...
    def export_bpmn(self, file_path: str, encoding: str = constants.DEFAULT_ENCODING) -> None:
    ...
    def export_petri_net(self, file_path: str, encoding: str = constants.DEFAULT_ENCODING) -> None:
